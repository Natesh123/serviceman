...
class AppConstants {
  static const String appName = 'Dirt2Tidy Serviceman';
  static const String appUser = 'Serviceman App';
  static const String appVersion = '3.2'; /// Flutter SDK: 3.29.3
  static const String baseUrl = 'https://app.dirt2tidy.com.au';
  ...
  static const String getServiceAvailabilitySettings = '/api/v1/serviceman/profile/available-time-schedule';
  static const String updateServiceAvailabilitySettings = '/api/v1/serviceman/profile/available-time-schedule';
  static const String walletTransactionUrl = '/api/v1/serviceman/wallet-transactions';
