...
import 'package:demandium_serviceman/feature/profile/widget/service_availability_setup.dart';
          ...
          SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                InkWell(
                  onTap: () {
                    Get.find<UserController>().getServiceAvailabilitySettingsFromServer();
                    Get.to(() => const ServiceAvailabilitySetup());
                  },
                  child: ProfileCardItem(
                    title: "service_availability".tr,
                    leadingIcon: Images.iconCalendar,
                  ),
                ),
                const SizedBox(height: Dimensions.paddingSizeSmall),
