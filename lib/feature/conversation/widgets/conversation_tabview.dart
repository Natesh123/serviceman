                  ...
                  child:Center(
                    child: Row(
                      children: [
                        ...
                        ) : (conversationController.getUnreadCustomerCount() > 0 ?
                        Container(height: 20 , width: 20,
                          ...
                          child: FittedBox(child: Text(
                            conversationController.getUnreadCustomerCount().toString(),
                            style: robotoRegular.copyWith(color: Colors.white),
                          ),
                          ),
                        ) : const SizedBox()),
                  ...
                  child:  Center(
                    child: Row(
                      children: [
                        ...
                        ) : (conversationController.getUnreadProviderCount() > 0 ?
                        Container(height: 20 , width: 20,
                          decoration: BoxDecoration(
                            shape: BoxShape.circle, color: Theme.of(context).colorScheme.error,
                          ),
                          ...
                          padding: const EdgeInsets.all(4),
                          child: FittedBox(child: Text(
                            conversationController.getUnreadProviderCount().toString(),
                            style: robotoRegular.copyWith(color: Colors.white),
                          ),
                          ),
                        ) : const SizedBox()),
