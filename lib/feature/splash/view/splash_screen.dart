...
class SplashScreenState extends State<SplashScreen> {
  ...
  void _route() {
    ...
    print("SplashScreen: Calling getConfigData...");
    Get.find<SplashController>().getConfigData().then((isSuccess) {
      print("SplashScreen: getConfigData finished. Success: $isSuccess");
      if(isSuccess){
        ...
        print("SplashScreen: Config failed. Navigating to Sign In as fallback...");
        Get.offNamed(RouteHelper.getSignInRoute("LogIn"));
      }
    }).catchError((error) {
       print("SplashScreen: getConfigData Error: $error");
       Get.offNamed(RouteHelper.getSignInRoute("LogIn"));
    });
  }
