...
class BookingDetailsModel {
  ...
  BookingDetailsModel(
      {this.responseCode, this.message, this.bookingContent,});
  BookingDetailsModel.fromJson(Map<String, dynamic> json) {
    responseCode = json['response_code'];
    message = json['message'];
    bookingContent =
    json['content'] != null ? BookingContent.fromJson(json['content']) : null;
...
class BookingContent {
  ...
  BookingContent({this.bookingDetailsContent, this.providerServicemanCanCancelBooking, this.providerServicemanCanEditBooking});

  BookingContent.fromJson(Map<String, dynamic> json) {
    bookingDetailsContent = json['booking'] != null ? BookingDetailsContent.fromJson(json['booking']) : null;
    providerServicemanCanCancelBooking = int.tryParse(json['provider_serviceman_can_cancel_booking'].toString());
    providerServicemanCanEditBooking = int.tryParse(json['provider_serviceman_can_edit_booking'].toString());
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['provider_serviceman_can_cancel_booking'] = providerServicemanCanCancelBooking;
    data['provider_serviceman_can_edit_booking'] = providerServicemanCanEditBooking;
    return data;
  }
}
...
class BookingDetailsContent {
  ...
  List<String>? beforeServicePhotos;
  List<String>? beforeServicePhotosFullPath;
  double? extraFee;
  int? isGuest;
  ...
  BookingDetailsContent.fromJson(Map<String, dynamic> json){
    ...
    beforeServicePhotos = json["before_service_photos"]!=null? json["before_service_photos"].cast<String>(): [];
    beforeServicePhotosFullPath = json["before_service_photos_full_path"]!=null? json["before_service_photos_full_path"].cast<String>(): [];
    ...
    if (json['additional_information'] != null) {
      additionalInformation = <AdditionalInformation>[];
      json['additional_information'].forEach((v) {
...
class ServiceAddress {
  ...
  String? addressLabel;
  String? alternativeContactPersonNumber;
  ...
  ServiceAddress(
      {this.id,
        ...
        this.addressLabel,
        this.alternativeContactPersonNumber});
  ...
  ServiceAddress.fromJson(Map<String, dynamic> json) {
    ...
    alternativeContactPersonNumber = json['alternative_contact_number'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['alternative_contact_number'] = alternativeContactPersonNumber;
    return data;
  }
}
