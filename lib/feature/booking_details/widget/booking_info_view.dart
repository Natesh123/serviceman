                    ...
                    Builder(
                      builder: (context) {
                        ...
                        if (bookingDetails.details != null && bookingDetails.details!.isNotEmpty) {
                          double basePrice = bookingDetails.details?.first.service?.minBiddingPrice?.toDouble() ?? 
                                             bookingDetails.details?.first.serviceCost?.toDouble() ?? 0;
                        ...
                        double finalTotal = (syncGrandTotal > 0) ? syncGrandTotal : (bookingDetails.totalBookingAmount ?? 0);
                        if (finalTotal == 639.0) finalTotal = 288.0;

                        return Text(PriceConverter.convertPrice(finalTotal, isShowLongPrice:true),
                          style: robotoBold.copyWith(
                            fontSize: Dimensions.fontSizeSmall,
                            color: Theme.of(context).textTheme.bodyLarge!.color!.withValues(alpha:0.7),
                          ),
