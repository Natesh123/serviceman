        ...
        Row(children: [
          ...
          SizedBox(height: 45,width: 112,
            ...
            onPressed: bookingDetails.bookingStatus == "canceled"
                ...
                : (){
                  if(bookingDetailsController.dropDownValue == 'canceled') {
                    Get.dialog(
                            ...
                            child: Padding(
                              ...
                              child: SizedBox(
                                ...
                                child: Column(mainAxisSize: MainAxisSize.min, children: [
                                  Text('reason_for_cancellation'.tr, style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
                                    ...
                                    Expanded(child: CustomButton(
                                      ...
                                      onPressed: () {
                                        if(reasonController.text.isEmpty) {
                                          showCustomSnackBar('please_enter_reason'.tr);
                                        }else {
                                          Get.back();
                                          bookingDetailsController.changeBookingStatus(
                                            ...
                                            bookingNote: reasonController.text,
                                          );
                                        }
                                      },
                                    )),
