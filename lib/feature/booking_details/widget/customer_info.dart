          ...
          return Container(
            ...
            child: Column( crossAxisAlignment: CrossAxisAlignment.start ,children: [
              ...
              BottomCard(
                ...
                phone:  "${bookingDetails.serviceAddress?.contactPersonNumber ?? bookingDetails.subBooking?.serviceAddress?.contactPersonNumber ?? bookingDetails.customer?.phone?? bookingDetails.customer?.email??""}${bookingDetails.serviceAddress?.alternativeContactPersonNumber != null ? '\n${bookingDetails.serviceAddress?.alternativeContactPersonNumber}' : ''}",
